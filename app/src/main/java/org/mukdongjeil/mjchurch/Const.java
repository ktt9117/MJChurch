...
public class Const {
    ...
    // Introduce page urls
    private static final String INTRODUCE_HOME_URL = BASE_URL + "/m/html/index.hpc?menuId=1749&topMenuId=1&menuType=27&newmenuAt=false&tPage=1";
    private static final String INTRODUCE_HISTORY_URL = BASE_URL + "/m/html/index.hpc?menuId=10004213&topMenuId=1&menuType=27&newmenuAt=true&tPage=1";
    private static final String INTRODUCE_FIND_MAP_URL = BASE_URL + "/m/html/index.hpc?menuId=1754&topMenuId=1&menuType=27&newmenuAt=false&tPage=1";
    private static final String INTRODUCE_TIME_TABLE_URL = BASE_URL + "/m/html/index.hpc?menuId=2273&topMenuId=1&menuType=27&newmenuAt=false&tPage=1";
    private static final String INTRODUCE_WORKER_URL = BASE_URL + "/m/html/index.hpc?menuId=1752&topMenuId=1&menuType=27&newmenuAt=false&tPage=1";
    ...
    // Training page urls
    private static final String TRAINING_HOME_URL = BASE_URL + "/m/html/index.hpc?menuId=10005607&topMenuId=3&menuType=27&newmenuAt=true";
    private static final String TRAINING_BIBLE_STUDY_URL = BASE_URL + "/m/html/index.hpc?menuId=10004998&topMenuId=3&menuType=27&newmenuAt=true";
    private static final String TRAINING_REARING_CLASS_URL = BASE_URL + "/m/html/index.hpc?menuId=10004997&topMenuId=3&menuType=27&newmenuAt=true";
    private static final String TRAINING_MOTHER_WISE_URL = BASE_URL + "/m/html/index.hpc?menuId=10004999&topMenuId=3&menuType=27&newmenuAt=true";
    private static final String TRAINING_DISCIPLE_URL = BASE_URL + "/m/html/index.hpc?menuId=10005002&topMenuId=3&menuType=27&newmenuAt=true";
    ...
    // Board page urls
    private static final String BOARD_THANKS_SHARE_URL = BASE_URL + "/m/board/index.hpc?menuId=10004076&topMenuId=6&menuType=1&newmenuAt=true";
    private static final String BOARD_GALLERY_LIST_URL = BASE_URL + "/m/photo/index.hpc?menuId=7203&topMenuId=6&menuType=9&newmenuAt=false";
    private static final String BOARD_GALLERY_CONTENT_URL = BASE_URL + "/m/photo/view.hpc?menuId=7203&topMenuId=6&menuType=9&newmenuAt=false&bbsNo=";
    private static final String BOARD_NEW_PERSON_LIST_URL = BASE_URL + "/m/photo/index.hpc?menuId=1770&topMenuId=6&menuType=9&newmenuAt=false";
    private static final String BOARD_NEW_PERSON_CONTENT_URL = BASE_URL + "/m/photo/view.hpc?menuId=1770&topMenuId=6&menuType=9&newmenuAt=false&bbsNo=";
    ...
    private static final String WORSHIP_LIST_URL = BASE_URL + "/m/board/index.hpc?menuId=";
    private static final String WORSHIP_LIST_EXT_URL = "&topMenuId=2&menuType=1&newmenuAt=true";

    private static final String WORSHIP_CONTENT_URL = BASE_URL + "/m/board/view.hpc?menuId=";
    private static final String WORSHIP_CONTENT_EXT1_URL = "&topMenuId=2&menuType=1&newmenuAt=true";
    private static final String WORSHIP_CONTENT_EXT2_URL = "&tPage=1&sPage=1&ssPage=1&topSubId=null&pageNow=1&bbsNo=";
